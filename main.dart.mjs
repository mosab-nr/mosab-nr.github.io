...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1960: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      _1961: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      _1962: x0 => globalThis.firebase_core.getApp(x0),
      _1963: () => globalThis.firebase_core.getApp(),
      _1966: () => globalThis.firebase_core.SDK_VERSION,
      _1973: x0 => x0.apiKey,
      _1975: x0 => x0.authDomain,
      _1977: x0 => x0.databaseURL,
      _1979: x0 => x0.projectId,
      _1981: x0 => x0.storageBucket,
      _1983: x0 => x0.messagingSenderId,
      _1985: x0 => x0.measurementId,
      _1987: x0 => x0.appId,
      _1989: x0 => x0.name,
      _1990: x0 => x0.options,
      _1991: (x0,x1) => x0.debug(x1),
      _1992: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1992(f,arguments.length,x0) }),
      _1993: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1993(f,arguments.length,x0,x1) }),
      _1994: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1995: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1996: (x0,x1) => x0.createScriptURL(x1),
      _1997: (x0,x1,x2) => x0.createScript(x1,x2),
      _1998: (x0,x1) => x0.appendChild(x1),
      ...
      _2013: x0 => new Array(x0),
      _2015: x0 => x0.length,
      _2017: (x0,x1) => x0[x1],
      _2018: (x0,x1,x2) => x0[x1] = x2,
      _2021: (x0,x1,x2) => new DataView(x0,x1,x2),
      _2023: x0 => new Int8Array(x0),
      _2024: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _2025: x0 => new Uint8Array(x0),
      _2031: x0 => new Uint16Array(x0),
      _2033: x0 => new Int32Array(x0),
      _2035: x0 => new Uint32Array(x0),
      _2037: x0 => new Float32Array(x0),
      _2039: x0 => new Float64Array(x0),
      _2041: (o, c) => o instanceof c,
      ...
      _2071: (decoder, codeUnits) => decoder.decode(codeUnits),
      _2072: () => new TextDecoder("utf-8", {fatal: true}),
      _2073: () => new TextDecoder("utf-8", {fatal: false}),
      _2074: x0 => new WeakRef(x0),
      _2075: x0 => x0.deref(),
      _2081: Date.now,
      _2083: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _2084: s => {
      ...
      _2086: () => typeof dartUseDateNowForTicks !== "undefined",
      _2087: () => 1000 * performance.now(),
      _2088: () => Date.now(),
      _2091: () => new WeakMap(),
      _2092: (map, o) => map.get(o),
      _2093: (map, o, v) => map.set(o, v),
      _2094: () => globalThis.WeakRef,
      _2105: s => JSON.stringify(s),
      _2106: s => printToConsole(s),
      _2107: a => a.join(''),
      _2108: (o, a, b) => o.replace(a, b),
      _2110: (s, t) => s.split(t),
      _2111: s => s.toLowerCase(),
      _2112: s => s.toUpperCase(),
      _2113: s => s.trim(),
      _2114: s => s.trimLeft(),
      _2115: s => s.trimRight(),
      _2117: (s, p, i) => s.indexOf(p, i),
      _2118: (s, p, i) => s.lastIndexOf(p, i),
      _2119: (s) => s.replace(/\$/g, "$$$$"),
      _2120: Object.is,
      _2121: s => s.toUpperCase(),
      _2122: s => s.toLowerCase(),
      _2123: (a, i) => a.push(i),
      _2127: a => a.pop(),
      ...
      _2140: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _2141: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _2142: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _2143: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _2144: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _2145: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _2146: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _2148: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _2149: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _2150: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _2151: (t, s) => t.set(s),
      _2153: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _2155: o => o.buffer,
      _2156: o => o.byteOffset,
      _2157: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _2158: (b, o) => new DataView(b, o),
      _2159: (b, o, l) => new DataView(b, o, l),
      _2160: Function.prototype.call.bind(DataView.prototype.getUint8),
      _2161: Function.prototype.call.bind(DataView.prototype.setUint8),
      _2162: Function.prototype.call.bind(DataView.prototype.getInt8),
      _2163: Function.prototype.call.bind(DataView.prototype.setInt8),
      _2164: Function.prototype.call.bind(DataView.prototype.getUint16),
      _2165: Function.prototype.call.bind(DataView.prototype.setUint16),
      _2166: Function.prototype.call.bind(DataView.prototype.getInt16),
      _2167: Function.prototype.call.bind(DataView.prototype.setInt16),
      _2168: Function.prototype.call.bind(DataView.prototype.getUint32),
      _2169: Function.prototype.call.bind(DataView.prototype.setUint32),
      _2170: Function.prototype.call.bind(DataView.prototype.getInt32),
      _2171: Function.prototype.call.bind(DataView.prototype.setInt32),
      _2174: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _2175: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _2176: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _2177: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _2178: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _2179: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _2192: (o, t) => o instanceof t,
      _2194: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2194(f,arguments.length,x0) }),
      _2195: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2195(f,arguments.length,x0) }),
      _2196: o => Object.keys(o),
      _2197: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _2198: (handle) => clearTimeout(handle),
      _2199: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _2200: (handle) => clearInterval(handle),
      _2201: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _2202: () => Date.now(),
      _2203: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _2204: (x0,x1,x2) => x0.fetch(x1,x2),
      _2205: (x0,x1) => x0.get(x1),
      _2206: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._2206(f,arguments.length,x0,x1,x2) }),
      _2207: (x0,x1) => x0.forEach(x1),
      _2209: () => new AbortController(),
      _2210: x0 => x0.getReader(),
      _2211: x0 => x0.read(),
      _2212: x0 => x0.cancel(),
      _2229: x0 => x0.trustedTypes,
      _2231: (x0,x1) => x0.text = x1,
      _2247: (s, m) => {
        try {
      ...
      _2248: (x0,x1) => x0.exec(x1),
      _2249: (x0,x1) => x0.test(x1),
      _2250: (x0,x1) => x0.exec(x1),
      _2251: (x0,x1) => x0.exec(x1),
      _2252: x0 => x0.pop(),
      _2254: o => o === undefined,
      _2273: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _2275: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _2276: o => o instanceof RegExp,
      _2277: (l, r) => l === r,
      _2278: o => o,
      _2279: o => o,
      _2280: o => o,
      ...
      _2282: o => o.length,
      _2285: (o, i) => o[i],
      _2286: f => f.dartFunction,
      _2287: l => arrayFromDartList(Int8Array, l),
      _2288: l => arrayFromDartList(Uint8Array, l),
      _2289: l => arrayFromDartList(Uint8ClampedArray, l),
      _2290: l => arrayFromDartList(Int16Array, l),
      _2291: l => arrayFromDartList(Uint16Array, l),
      _2292: l => arrayFromDartList(Int32Array, l),
      _2293: l => arrayFromDartList(Uint32Array, l),
      _2294: l => arrayFromDartList(Float32Array, l),
      _2295: l => arrayFromDartList(Float64Array, l),
      _2296: x0 => new ArrayBuffer(x0),
      _2297: (data, length) => {
      ...
      _2298: l => arrayFromDartList(Array, l),
      _2299: () => ({}),
      _2300: () => [],
      _2301: l => new Array(l),
      _2302: () => globalThis,
      ...
      _2317: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const setValue = dartInstance.exports.$wasmI32ArraySet;
        for (let i = 0; i < length; i++) {
          setValue(wasmArray, wasmArrayOffset + i, jsArray[jsArrayOffset + i]);
        }
      },
      _2318: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _2330: x0 => x0.flags,
      _2331: x0 => x0.multiline,
      _2332: x0 => x0.ignoreCase,
      _2333: x0 => x0.unicode,
      _2334: x0 => x0.dotAll,
      _2335: (x0,x1) => x0.lastIndex = x1,
      _2337: (o, p) => o[p],
      _2338: (o, p, v) => o[p] = v,
      _2339: (o, p) => delete o[p],
      _2340: x0 => x0.random(),
      _2341: x0 => x0.random(),
      _2345: () => globalThis.Math,
      _2347: Function.prototype.call.bind(Number.prototype.toString),
      _2348: (d, digits) => d.toFixed(digits),
      _3793: (x0,x1) => x0.type = x1,
      _3801: (x0,x1) => x0.crossOrigin = x1,
      _3803: (x0,x1) => x0.text = x1,
      _4278: () => globalThis.window,
      _4342: x0 => x0.navigator,
      _4604: x0 => x0.trustedTypes,
      _4733: x0 => x0.userAgent,
      _6980: x0 => x0.signal,
      _7059: () => globalThis.document,
      _7154: x0 => x0.head,
      _8884: x0 => x0.value,
      _8886: x0 => x0.done,
      _9609: x0 => x0.url,
      _9611: x0 => x0.status,
      _9613: x0 => x0.statusText,
      _9614: x0 => x0.headers,
      _9615: x0 => x0.body,
      _14008: () => globalThis.console,
      _14039: x0 => x0.name,
      _14040: x0 => x0.message,
      _14041: x0 => x0.code,
